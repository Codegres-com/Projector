...
const TaskForm = ({ projectId, task, onSave, onCancel }) => {
  ...
  useEffect(() => {
    // Fetch users for assignment (assume project members or all users for now)
    // Ideally we should fetch project members only
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center z-50">
      <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-lg">
        <h2 className="text-2xl font-bold mb-6">{task ? 'Edit Task' : 'New Task'}</h2>
